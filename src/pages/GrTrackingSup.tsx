...
const GrTrackingSup = () => {
  ...
  const applyColumnFilters = (dataToFilter: GrTrackingSup[]) => {
    ...
    if (columnFilters.bpIdFilter) {
      filtered = filtered.filter(
        (item) =>
          item.bp_id
            ?.toLowerCase()
            .includes(columnFilters.bpIdFilter.toLowerCase()),
      );
    }
    ...
    if (columnFilters.bpNameFilter) {
      filtered = filtered.filter(
        (item) =>
          item.bp_name
            ?.toLowerCase()
            .includes(columnFilters.bpNameFilter.toLowerCase()),
      );
    }
    ...
    if (columnFilters.poNoFilter) {
      filtered = filtered.filter(
        (item) =>
          item.po_no
            ?.toLowerCase()
            .includes(columnFilters.poNoFilter.toLowerCase()),
      );
    }
    ...
    if (columnFilters.receiptNoFilter) {
      filtered = filtered.filter(
        (item) =>
          item.receipt_no
            ?.toLowerCase()
            .includes(columnFilters.receiptNoFilter.toLowerCase()),
      );
    }
    ...
    if (columnFilters.poReferenceFilter) {
      filtered = filtered.filter(
        (item) =>
          item.po_reference
            ?.toLowerCase()
            .includes(columnFilters.poReferenceFilter.toLowerCase()),
      );
    }
    ...
    if (columnFilters.currencyFilter) {
      filtered = filtered.filter(
        (item) =>
          item.currency
            ?.toLowerCase()
            .includes(columnFilters.currencyFilter.toLowerCase()),
      );
    }
    ...
    if (columnFilters.packingSlipFilter) {
      filtered = filtered.filter(
        (item) =>
          item.packing_slip
            ?.toLowerCase()
            .includes(columnFilters.packingSlipFilter.toLowerCase()),
      );
    }
    ...
    if (columnFilters.partNoFilter) {
      filtered = filtered.filter(
        (item) =>
          item.part_no
            ?.toLowerCase()
            .includes(columnFilters.partNoFilter.toLowerCase()),
      );
    }
    ...
    if (columnFilters.itemDescFilter) {
      filtered = filtered.filter(
        (item) =>
          item.item_desc
            ?.toLowerCase()
            .includes(columnFilters.itemDescFilter.toLowerCase()),
      );
    }
    ...
    if (columnFilters.itemNoFilter) {
      filtered = filtered.filter(
        (item) =>
          item.item_no
            ?.toLowerCase()
            .includes(columnFilters.itemNoFilter.toLowerCase()),
      );
    }
    ...
    if (columnFilters.unitFilter) {
      filtered = filtered.filter(
        (item) =>
          item.unit
            ?.toLowerCase()
            .includes(columnFilters.unitFilter.toLowerCase()),
      );
    }
    ...
    if (columnFilters.itemTypeFilter) {
      ...
      filtered = filtered.filter(
        (item) =>
          item.item_type_desc
            ?.toLowerCase()
            .includes(columnFilters.itemTypeFilter.toLowerCase()),
      );
    }
    ...
    if (columnFilters.unitPriceFilter) {
      ...
      filtered = filtered.filter(
        (item) => item.receipt_unit_price?.toString().includes(filterValue),
      );
    }
    ...
    if (columnFilters.requestQtyFilter) {
      ...
      filtered = filtered.filter(
        (item) => item.request_qty?.toString().includes(filterValue),
      );
    }
    ...
    if (columnFilters.receiptQtyFilter) {
      ...
      filtered = filtered.filter(
        (item) => item.actual_receipt_qty?.toString().includes(filterValue),
      );
    }
    ...
    if (columnFilters.approveQtyFilter) {
      ...
      filtered = filtered.filter(
        (item) => item.approve_qty?.toString().includes(filterValue),
      );
    }
    ...
    if (columnFilters.receiptAmountFilter) {
      ...
      filtered = filtered.filter(
        (item) => item.receipt_amount?.toString().includes(filterValue),
      );
    }
      ...
      filtered = filtered.filter(
        (item) =>
          item.inv_supplier_no
            ?.toLowerCase()
            .includes(columnFilters.invSupplierNoFilter.toLowerCase()),
      );
    }
    ...
    if (columnFilters.invDocNoFilter) {
      filtered = filtered.filter(
        (item) =>
          item.inv_doc_no
            ?.toLowerCase()
            .includes(columnFilters.invDocNoFilter.toLowerCase()),
      );
    }
    ...
    if (columnFilters.invDocDateFilter) {
      filtered = filtered.filter(
        (item) => item.inv_doc_date?.includes(columnFilters.invDocDateFilter),
      );
    }
    ...
    if (columnFilters.invQtyFilter) {
      ...
      filtered = filtered.filter(
        (item) => item.inv_qty?.toString().includes(filterValue),
      );
    }
    ...
    if (columnFilters.invAmountFilter) {
      ...
      filtered = filtered.filter(
        (item) => item.inv_amount?.toString().includes(filterValue),
      );
    }
    ...
    if (columnFilters.invDueDateFilter) {
      filtered = filtered.filter(
        (item) => item.inv_due_date?.includes(columnFilters.invDueDateFilter),
      );
    }
    ...
    if (columnFilters.paymentDocFilter) {
      filtered = filtered.filter(
        (item) =>
          item.payment_doc
            ?.toLowerCase()
            .includes(columnFilters.paymentDocFilter.toLowerCase()),
      );
    }
  ...
  const fetchInvLineData = async (params: FilterParams = {}) => {
    ...
    try {
      ...
      const url = queryParams
        ? `${API_Inv_Line_Admin()}?${queryParams}`
        : API_Inv_Line_Admin();
...
>>>>>>> aff2177ce6a8fa0451522f3005a34d57637ff647
          // Apply client-side filtering if backend doesn't filter
          if (mergedParams.bp_id) {
            invLineList = invLineList.filter(
              (item: { bp_id: string | undefined }) =>
                item.bp_id === mergedParams.bp_id,
            );
          }
          ...
          if (grDateFrom && grDateTo) {
            invLineList = invLineList.filter(
              (item: { actual_receipt_date: string }) => {
  ...
  const handleExcelExport = () => {
    ...
    try {
      ...
      const calculateColumnWidths = () => {
        ...
        for (let i = 0; i < headers.length; i++) {
          ...
          const finalWidth = Math.min(
            Math.max(maxWidth + padding, minWidth),
            maxWidth_limit,
          );
      ...
      toast.success(
        `Exported ${filteredData.length} records to ${filename} with auto-fitted columns`,
      );
    } catch (error) {
  ...
  const applyFormFilters = () => {
    ...
    if (filterParams.packing_slip) {
      filtered = filtered.filter(
        (row) =>
          row.packing_slip
            ?.toLowerCase()
            .includes(filterParams.packing_slip!.toLowerCase()),
      );
    }
    ...
    if (filterParams.receipt_no) {
      filtered = filtered.filter(
        (row) =>
          row.receipt_no
            ?.toLowerCase()
            .includes(filterParams.receipt_no!.toLowerCase()),
      );
    }
    ...
    if (filterParams.tax_number) {
      filtered = filtered.filter(
        (row) =>
          row.inv_doc_no
            ?.toLowerCase()
            .includes(filterParams.tax_number!.toLowerCase()),
      );
    }
    ...
    if (filterParams.status) {
      filtered = filtered.filter(
        (row) =>
          row.is_confirmed !== undefined &&
          String(row.is_confirmed)
            .toLowerCase()
    ...
    if (filterParams.tax_date) {
      filtered = filtered.filter(
        (row) => row.inv_doc_date?.includes(filterParams.tax_date!),
      );
    }

    if (filterParams.po_date) {
      filtered = filtered.filter(
        (row) => row.created_at?.includes(filterParams.po_date!),
      );
    }
    ...
    if (filterParams.dn_number) {
      filtered = filtered.filter(
        (row) =>
          row.receipt_no
            ?.toLowerCase()
            .includes(filterParams.dn_number!.toLowerCase()),
      );
    }
        ...
        <div className="flex space-x-4">
            ...
            <input
              ...
              value={
                isSupplierFinance
                  ...
                  : businessPartners.find((p) => p.bp_code === selectedSupplier)
                      ?.bp_name || ''
              }
              readOnly
            />
          ...
          <div className="flex w-1/3 items-center gap-2">
            ...
            <input
              ...
              placeholder="---------- ----"
              onChange={(e) =>
                handleInputChange('packing_slip', e.target.value)
              }
            />
          </div>
        ...
        <div className="overflow-x-auto shadow-md border rounded-lg mb-6">
          <table className="w-full text-sm text-left">
            ...
            <thead className="bg-gray-100 uppercase text-gray-700">
              {' '}
              <tr>
                <th className="px-4 py-2 text-gray-700 text-center border-t border-b min-w-[150px]">
                  BP ID
                </th>
                <th className="px-4 py-2 text-gray-700 text-center border-t border-b min-w-[250px]">
                  BP Name
                </th>
                <th className="px-4 py-2 text-gray-700 text-center border-t border-b min-w-[150px]">
                  PO NO
                </th>
                <th className="px-4 py-2 text-gray-700 text-center border-t border-b min-w-[120px]">
                  DN NO
                </th>
                <th className="px-4 py-2 text-gray-700 text-center border-t border-b min-w-[220px]">
                  PO Reference
                </th>
                <th className="px-4 py-2 text-gray-700 text-center border-t border-b min-w-[130px]">
                  Receipt Date
                </th>
                <th className="px-4 py-2 text-gray-700 text-center border-t border-b min-w-[280px]">
                  Supplier REF No
                </th>
                <th className="px-4 py-2 text-gray-700 text-center border-t border-b min-w-[180px]">
                  Part No
                </th>
                <th className="px-4 py-2 text-gray-700 text-center border-t border-b min-w-[200px]">
                  Item Desc
                </th>
                <th className="px-4 py-2 text-gray-700 text-center border-t border-b min-w-[150px]">
                  ERP PART NO
                </th>
                <th className="px-4 py-2 text-gray-700 text-center border-t border-b min-w-[80px]">
                  Unit
                </th>
                <th className="px-4 py-2 text-gray-700 text-center border-t border-b min-w-[120px]">
                  Item Type
                ...
                <th className="px-4 py-2 text-gray-700 text-center border-t border-b min-w-[100px]">
                  Confirmed
                </th>
                <th className="px-4 py-2 text-gray-700 text-center border-t border-b min-w-[150px]">
                  Inv Supplier No
                ...
                <th className="px-4 py-2 text-gray-700 text-center border-t border-b min-w-[160px]">
                  Invoice Due Date
                </th>
                <th className="px-4 py-2 text-gray-700 text-center border-t border-b min-w-[130px]">
                  Payment Doc
              ...
              <tr>
                <td className="px-2 py-2 border-b">
                  <input
                    ...
                    onChange={(e) =>
                      handleColumnFilterChange('bpIdFilter', e.target.value)
                    }
                  />
                </td>
                <td className="px-2 py-2 border-b">
                  <input
                    ...
                    onChange={(e) =>
                      handleColumnFilterChange('bpNameFilter', e.target.value)
                    }
                  />
                </td>
                <td className="px-2 py-2 border-b">
                  <input
                    ...
                    onChange={(e) =>
                      handleColumnFilterChange('poNoFilter', e.target.value)
                    }
                  />
                </td>
                <td className="px-2 py-2 border-b">
                ...
                <td className="px-2 py-2 border-b">
                  <input
                    ...
                    onChange={(e) =>
                      handleColumnFilterChange('partNoFilter', e.target.value)
                    }
                  />
                </td>
                <td className="px-2 py-2 border-b">
                  <input
                    ...
                    onChange={(e) =>
                      handleColumnFilterChange('itemDescFilter', e.target.value)
                    }
                  />
                </td>
                <td className="px-2 py-2 border-b">
                  <input
                    ...
                    onChange={(e) =>
                      handleColumnFilterChange('itemNoFilter', e.target.value)
                    }
                  />
                </td>
                <td className="px-2 py-2 border-b">
                  <input
                    ...
                    onChange={(e) =>
                      handleColumnFilterChange('unitFilter', e.target.value)
                    }
                  />
                </td>
                <td className="px-2 py-2 border-b">
                  <input
                    ...
                    onChange={(e) =>
                      handleColumnFilterChange('itemTypeFilter', e.target.value)
                    }
                  />
                </td>
                <td className="px-2 py-2 border-b">
                  <input
                    ...
                    onChange={(e) =>
                      handleColumnFilterChange('currencyFilter', e.target.value)
                    }
                  />
                </td>
                <td className="px-2 py-2 border-b">
                ...
                <td className="px-2 py-2 border-b">
                  <input
                    ...
                    onChange={(e) =>
                      handleColumnFilterChange('invDocNoFilter', e.target.value)
                    }
                  />
                </td>
                <td className="px-2 py-2 border-b">
                ...
                <td className="px-2 py-2 border-b">
                  <input
                    ...
                    onChange={(e) =>
                      handleColumnFilterChange('invQtyFilter', e.target.value)
                    }
                  />
                </td>
                <td className="px-2 py-2 border-b">
            ...
            <tbody>
              {isLoading ? (
                ...
                paginatedData.map((item, index) => (
                  <tr
                    key={`${item.gr_no}-${item.po_line}-${index}`}
                  ...
                  >
                    ...
                    <td className="px-6 py-3 text-center border-b">
                      {item.inv_doc_date
                        ? new Date(item.inv_doc_date).toLocaleDateString()
                        : ''}
                    </td>
                    <td className="px-6 py-3 text-center border-b">
                    ...
                    <td className="px-6 py-3 text-center border-b">
                      {item.inv_due_date
                        ? new Date(item.inv_due_date).toLocaleDateString()
                        : ''}
                    </td>
                    <td className="px-6 py-3 text-center border-b">
                      {item.payment_doc || ''}
                    ...
                    <td className="px-6 py-3 text-center border-b">
                      {item.payment_doc_date
                        ? new Date(item.payment_doc_date).toLocaleDateString()
                        : ''}
                    </td>
                  </tr>
                ))
